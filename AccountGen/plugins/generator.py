...
buttons=[
    [Button.url("Channel", url="https://t.me/OPbots"), Button.url("Bot", url=f"https://t.me/{botname}")],
    [Button.url("Donate", url="https://t.me/DonateEylexBot"),
    Button.url("Dev", url="https://t.me/AnonymousOwner")]
])
